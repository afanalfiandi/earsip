import { RefreshControl, ActivityIndicator, Modal, Image, ToastAndroid, StyleSheet, BackHandler, FlatList, Text, TouchableOpacity, View, ScrollView } from 'react-native'
                ...
                return (
                  <View style={styles.itemContainer} key={item.id_dokumen}>
                    ...
                    <View style={styles.contentTextContainer}>
                      <Text style={[styles.cardTitle, { marginBottom: 2 }]}>{item.title}</Text>
                      <Text style={styles.cardText}>{item.tgl}</Text>
                    </View>
                    <View style={styles.contentBtnContainer}>
                      <Menu>
                        ...
                        <MenuOptions style={{ padding: 10 }}>
                          <MenuOption onSelect={() => alert(`Lihat`)} text='Lihat' />
                          <View style={styles.divider} />
                          <MenuOption onSelect={() => alert(`Ubah`)} text='Ubah' />
                          <View style={styles.divider} />
                          <MenuOption onSelect={() => alert(`Hapus`)} text='Hapus' />
                        </MenuOptions>
                      </Menu>
                    </View>
                  </View>
