    ...
    return (
        <View style={styles.container}>
                    ...
                    <View style={styles.modalView}>
                        <View style={styles.formGroup}>
                            ...
                            <View style={styles.docPicker}>
                                <TextInput placeholder='Masukkan Nama Dokumen' value={namaFile} onChangeText={setNamaFile} />
                            </View>
                        </View>
                        <View style={styles.formGroup}>
            ...
            <View style={styles.header}>
                <Text style={styles.greetings}>Dokumen Pribadi</Text>
                        ...
                        return (
                            <View style={[styles.itemContainer]} key={item.id_dokumen}>
                                ...
                                <View style={styles.contentTextContainer}>
                                    <Text style={[styles.cardTitle, { marginBottom: 2 }]}>{item.nama_dokumen}</Text>
